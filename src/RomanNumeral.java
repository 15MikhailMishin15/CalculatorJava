public enum RomanNumeral {
    ...
    LXXXI(81), LXXXII(82), LXXXIII(83), LXXXIV(84), LXXXV(85), LXXXVI(86), LXXXVII(87), LXXXVIII(88), LXXXIX(89),
    ...
    public static int romanToArabic(String roman) {
        ...
        while (i < roman.length()) {
            if (i + 1 < roman.length() ) {
                result += RomanNumeral.valueOf(roman.substring(i, i + 2)).value;
                i += 2;
            } else {
                result += RomanNumeral.valueOf(String.valueOf(roman.charAt(i))).value;
                i++;
            }
        }
        return result;
    ...
    public static boolean isRoman(String input) {
        return input.matches("^(?:\\s*I\\s*|[IVXLCDM]+)(\\s*[+\\-*/]\\s*(?:\\s*I\\s*|[IVXLCDM]+))?$");
    }
}